...
return [
    'title' => 'Private English lessons | Online or In-Person at Your Location',
    'meta' => 'Private English lessons. Online or in-person at your location.',
    'heading' => 'Speak English fluently',
    'subheading' => 'Private one-to-one online English lessons at the time and day of your choice.',
    'become_fluent' => 'Private Online English Lessons',
    'become_fluent_text' => 'Become fluent in English with lessons that focus on helping you improve the specific skills you need, using an intensive one-to-one focus.',
    '5' => '5',
    'rating_on' => 'rating on',
    'grammar_title' => 'Understand grammar & tenses',
    'grammar_text' => "Using the right tense can be one of the most difficult parts of speaking English.
    ...
    'vocabulary_text' => 'Do you struggle to find the right words when speaking English? This course focuses
        on teaching you useful new words that you will use every day.',
    'speaking_title' => 'Improve your speaking ability',
    'speaking_text' => "Practice, practice, practice. That's what we help you do to improve your English
        speaking skills, build your confidence, and finally feel comfortable speaking English.",
    'how_it_works_title' => 'How it works',
    'hiw_1' => '1. Create your free Weaver School account so you can access our website.',
    ...
    'standard_price' => '$420',
    'total' => 'total',
    'standard_description' => "Based on your selected teacher's hourly rate and a minimum 12 hours of lessons.",
    'choose_teacher' => 'Choose your own teacher',
    'choose_lessons' =>'Choose between 1 or 2 weekly lessons',
    'weekly_homework' => '2-3 hours of homework each week',
    'weekly_quizzes' => 'Weekly graded quizzes with instant feedback',
    'lesson_plan' => 'Personalized lesson plan',
    'get_started_button' => 'Get started',
    'monthly_badge' => 'Monthly',
    'monthly_price' => '$140',
    'per_month' => '/mo',
    'monthly_description' => 'Based on the total price divided by 3 equal payments made once every 4 weeks.',
    ...
    'faq_text_4' => "You don't need to download anything to follow our lessons. You can simply use our meeting tool in your web browser.",
