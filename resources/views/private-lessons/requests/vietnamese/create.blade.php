<x-layouts.app>
    <x-slot name="title">
        Request online private Vietnamese lessons
    </x-slot>
<x-layouts.guest>
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="mt-12 mx-20 md:mx-12">
                    ...
                    <div class="text-2xl text-gray-100 mt-8">
                        ...
                        <p>Your online private Vietnamese lessons will be scheduled at the time and day of your choice. Just fill
                            out the form below and we'll respond via email within 24 hours.</p>
                    </div>
                    <div class="mt-10 mb-5 p-5 rounded-lg bg-gray-100">
                        <form action="{{ route('private-lessons.requests.vietnamese.store') }}" method="POST">
                            @csrf
                            <x-honeypot />
