    ...
    <x-dashboard.index>
        ...
        <div class="max-w-xl mx-auto mt-6 pb-1 bg-white shadow-lg rounded-lg overflow-visible">
            <div class="p-6">
                ...
                <div class="mt-8">
                    ...
                    <div class="text-gray-600 text-xl prose prose-xl">{!! Str::of($essay->feedback)->markdown() !!}</div> <!-- Assuming feedback is safe to render as HTML -->
                </div>
            </div>
        ...
        <div class="flex my-10">
            <div class="mx-auto space-x-8">
                <a class="text-teal-700 dark:text-teal-500 hover:text-teal-500 dark:hover:text-teal-300 font-bold mx-auto" href="/{{ session('locale') }}/dashboard/essays/feedback">Back to all essays</a>
