                    ...
                    <li class="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 ease-in-out">
                        <div class="p-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <a href="/{{ session('locale') }}/dashboard/essays/feedback/{{ $essay->id }}" class="text-lg font-semibold text-gray-900 hover:text-teal-500 transition-colors duration-300">
                                        {{ mb_substr($essay->topic, 0, 40) }}...
                                    </a>
                                    <p class="text-sm text-gray-500">{{ mb_substr(strip_tags($essay->feedback), 0, 80) }}...</p>
                                </div>
                            </div>
                        </div>
                    </li>
