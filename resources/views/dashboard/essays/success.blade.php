...
<div x-data="{
    ...
    <section class="bg-teal-700 py-8 rounded-lg">
        <div class="text-center text-white">
            <h2 class="text-2xl font-bold mb-4">Submission processing...</h2>
            <p class="text-xl font-semibold mb-8">{{ max(0, 2 - count(auth()->user()->essaySubmissions ?? [])) }} trial submissions left!</p>
            {{-- <a href="{{ route('subscription-checkout', ['essays', 1003])}}" class="bg-teal-300 hover:bg-teal-500 text-gray-700 hover:text-white font-bold py-2 px-6 rounded-lg mr-4">Upgrade to Annual</a>                 --}}
            <a href="{{ route('subscription-checkout', ['essays', 1001])}}" class="bg-white hover:bg-teal-100 text-teal-700 hover:text-teal-900 font-semibold py-2 px-6 rounded-lg border-teal-300 hover:border-teal-500">Unlock Unlimited Access</a>                      
        </div>
    </section>

    <section class="relative bg-gray-900 py-12 px-6 mt-12 flex rounded-lg">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="ml-10">
                ...
                <div class="flex items-center mb-8">
                    ...
                    <div class="ml-4">
                        <p class="text-lg font-semibold">Today: Unlock AI IELTS Coach Pro</p>
                    </div>
                </div>
                <!-- Step 4 -->
                <div class="flex items-center mb-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 prose prose-xl dark:prose-invert mx-auto mt-8 gap-x-8">
        <div class="col-span-1">
            ...
            <p class="leading-relaxed text-xl text-center">Your AI IELTS Coach will teach you how to write better essays. From Thesis Statements, to Body Paragraphs, you'll get customized explanations and get real-time feedback on your actual writing.</p>
        </div>
        <div class="col-span-1">
        ...
        <div class="col-span-1">
            ...
            <p class="leading-relaxed text-xl text-center">Let your AI IELTS Coach walk you through the process of creating an outline for your IELTS essays until you master the process yourself.</p>
        </div>
    </div>
    ...
    <div class="flex flex-wrap float-right justify-center items-stretch">
        <a href="/{{ session('locale') }}/dashboard/essays/feedback" class="bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-6 rounded-lg mr-4">Go to Writing Feedback</a>         
    </div>
    </div>
