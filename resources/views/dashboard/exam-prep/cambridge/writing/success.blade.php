...
<div x-data="{
    ...
    <div class="flex">
        ...
        <span class="flex"><a href="{{ route('dashboard.exam-prep.cambridge.writing.feedback.index', ['locale' => session('locale', 'en')])}}" class="text-teal-900 dark:text-white hover:text-violet-400 font-bold py-2 px-6 rounded-lg mr-4">
    ...
    <div class="flex flex-wrap float-right justify-center items-stretch">
        <a href="{{ route('dashboard.exam-prep.cambridge.writing.feedback.index', ['locale' => session('locale', 'en')])}}" class="bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-6 rounded-lg mr-4">Go to Writing Feedback</a>         
    </div>
    </div>
