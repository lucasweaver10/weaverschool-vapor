<x-layouts.app>
    ...
    <x-dashboard.index>
                    ...
                    <li class="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 ease-in-out">
                        <div class="p-6">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">                                
                                    <a href="{{ route('dashboard.exam-prep.pearson.writing.feedback.show', ['locale' => session('locale', 'en'), 'id' => $essay->id]) }}" class="text-lg font-semibold text-gray-900 hover:text-teal-500 transition-colors duration-300">
        ...
        <div class="flex my-4">
            <a href="{{ route('dashboard.exam-prep.pearson.writing.submit', ['locale' => session('locale', 'en')])}}" class="bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded mt-4 mx-auto">
                Submit new essay
            </a>
        </div>
    </x-dashboard.index>
