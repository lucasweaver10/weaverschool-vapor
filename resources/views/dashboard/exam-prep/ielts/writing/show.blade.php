<x-layouts.app>
    ...
    <x-dashboard.index>
        ...
        <div x-data="{ activeTab: 'overview' }">
            ...
            <div x-cloak x-show="activeTab === 'overview' " class="max-w-3xl mx-auto mt-6 pb-1 bg-white shadow-lg rounded-lg overflow-visible">
                <div class="p-6">
        ...
        <div x-cloak x-show="activeTab === 'sentence-structure' " class="max-w-4xl mx-auto mt-6 p-8 bg-white shadow-lg rounded-lg overflow-visible">
            ...
            <!-- Band 7 Section -->
            <div class="mb-6">
                <div class="text-gray-700 font-bold mb-4">Benchmark: Band 7 ("uses a variety of complex structures"):</div>
            ...
            <!-- Band 8 Section -->
            <div class="mb-12">
                <div class="text-gray-700 font-bold mb-4">Benchmark: Band 8 ("uses a wide range of structures"):</div>
                <div class="flex text-sm justify-between text-gray-700">
        ...
        <div x-cloak x-show="activeTab === 'vocabulary' " class="max-w-4xl mx-auto mt-6 p-8 bg-white shadow-lg rounded-lg overflow-visible">
            ...
            <!-- Band 8 Section -->
            <div class="mb-12">
                <div class="text-gray-700 font-bold mb-2">Benchmark: Percentages of a Band 8 ("uses a wide range of vocablary fluently...") Essay:</div>
                <div class="flex text-sm justify-between text-gray-700">                    
        ...
        <div class="flex my-10">
            <div class="mx-auto space-x-8">
                <a class="text-teal-700 dark:text-teal-500 hover:text-teal-500 dark:hover:text-teal-300 font-bold mx-auto" href="{{ route('dashboard.exam-prep.ielts.writing.feedback.index', ['locale' => session('locale', 'en')])}}">Back to all essays</a>
                <a href="{{ route('dashboard.exam-prep.ielts.writing.submit', ['locale' => session('locale', 'en')])}}" class="bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded mt-4 mr-12">
                    Submit new essay
                </a>
            </div>
        </div>
