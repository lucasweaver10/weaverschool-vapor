...
<div>   
    ...
    <div class="flex">
        ...
        <span class="flex"><a href="{{ route('dashboard.exam-prep.ielts.writing.feedback.index', ['locale' => session('locale', 'en')])}}" class="text-teal-900 dark:text-white hover:text-violet-400 font-bold py-2 px-6 rounded-lg mr-4">
            Go to Writing Feedback
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline-flex mb-1 ml-1 size-6">
    ...
    <section class="relative dark:bg-gray-800 py-12 px-6 mt-10 flex rounded-lg">
    ...
    <div class="flex flex-wrap float-right justify-center items-stretch">
        <a href="{{ route('dashboard.exam-prep.ielts.writing.feedback.index', ['locale' => session('locale', 'en')])}}" class="bg-violet-500 hover:bg-violet-600 text-white font-bold py-2 px-6 rounded-lg mr-4">Go to Writing Feedback</a>         
    </div>
    </div>
