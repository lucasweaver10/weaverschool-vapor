        ...
        <main class="mt-0 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div class="sm:text-center lg:text-left pt-5 ml-16 mr-8">
            <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span class="block xl:inline">@lang('pages/learn-english.heading_1')</span>
              <span class="block text-blue-400 xl:inline">@lang('pages/learn-english.heading_2')</span>
            </h1>
            <p class="mt-3 text-base sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                @lang('pages/learn-english.lead_text')
            </p>
            <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              <div class="rounded-md mt-3">
                <a href="/register" class="unstyled w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-400 hover:bg-blue-300 md:py-4 md:text-lg md:px-10">
                    @lang('pages/learn-english.create_account_button')
                </a>
              </div>
