<aside class="absolute bg-blue-300 h-screen w-64 hidden sm:block shadow-xl fixed-top top-0">
  <div class="p-6">
      <a href="index.html" class="text-white text-3xl font-semibold hover:text-gray-300">Dashboard</a>
