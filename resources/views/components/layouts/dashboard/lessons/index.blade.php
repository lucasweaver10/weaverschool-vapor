            ...
            <div class="space-y-6 lg:col-span-1 lg:col-start-3">
                <div class="bg-white px-4 pt-3 pb-5 shadow sm:rounded-lg sm:px-6">
                    ...
                    <nav class="space-y-1" aria-label="Sidebar">
                        ...
                        <a href="lessons" class="@if(request()->routeIs('dashboard.lessons.index*')) bg-black text-white @else bg-white text-black @endif  hover:bg-black hover:text-black flex items-center rounded-md px-3 py-2 text-sm font-medium">
                        ...
                        <a href="{{ route('dashboard.courses.show', ['locale' => session('locale'), 'id' => $course->id ])}}"
                           class="@if(request()->routeIs('dashboard.courses.show')) bg-black text-white @else bg-white text-black @endif  hover:text-black flex items-center rounded-md px-3 py-2 text-sm font-medium" aria-current="page">
