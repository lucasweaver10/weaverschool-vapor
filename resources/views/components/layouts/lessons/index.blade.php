          ...
          <section aria-labelledby="section-2-title">
            ...
            <div class="overflow-hidden rounded-lg bg-white shadow">        
                {{-- <div class="p-6 flex flex-1 flex-col">
                    ...
                    <a href="{{ route('dashboard.lessons.guided-practice.show', ['locale' => session('locale'), 'courseId' => $course->id, 'lessonId' => $lesson->id]) }}" class="text-black hover:text-gray-600 group flex items-center px-2 py-2 text-sm font-medium rounded-md">            
                        Guided Practice
                    </a>
                    <a href="{{ route('dashboard.lessons.free-practice.show', ['locale' => session('locale'), 'courseId' => $course->id, 'lessonId' => $lesson->id]) }}" class="text-black hover:text-gray-600 group flex items-center px-2 py-2 text-sm font-medium rounded-md">            
                        Free Practice
                    </a>
                    <!-- Solution needed below for quizzes -->
                    <a href="{{ route('dashboard.lessons.vocabulary-words.index', ['locale' => session('locale'), 'courseId' => $course->id, 'lessonId' => $lesson->id]) }}" class="text-black hover:text-gray-600 group flex items-center px-2 py-2 text-sm font-medium rounded-md">            
                        Quiz
                    </a>
                </div> --}}
