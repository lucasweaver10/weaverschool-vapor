<x-layouts.app>
<x-slot name="title">Quick Notes</x-slot>
    <nav class="bg-gray-900 text-white p-4" x-data="{ mobileMenuOpen: false }">
        <div class="flex justify-between items-center">
            <div class="flex items-center">
                <a href="/{{ session('locale') ?? 'en' }}/dashboard" class="">
                    <img src="{{ config('app.logo_dark') }}" alt="weaver school logo for flashcards tool" class="w-32 mr-8">
                </a>
            </div>
            <!-- Hamburger Button -->
            <div class="relative">
