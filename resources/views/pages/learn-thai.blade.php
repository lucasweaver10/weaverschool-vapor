<x-layouts.app>      
    <x-slot name="title">
        Learn Thai with customized language learning tools powered by AI
    </x-slot>
    <x-slot name="description">
        Learn Thai with customized language learning powered by AI. Learn any Thai topic you choose with vocabulary words, key phrases, grammar explanations, and flashcards created just for you.
    </x-slot>
<x-layouts.guest>
...
<div class="dark:bg-gray-900 pt-20 pb-16 px-5 sm:px-0 text-center lg:pt-16">
    <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 dark:text-gray-100 sm:text-7xl">
        ...
        <span class="relative whitespace-nowrap text-teal-500 dark:text-teal-300">
            ...
            <span class="relative">Learn Thai</span>
        </span>
    ...
    <p class="mx-auto mt-10 max-w-4xl text-2xl tracking-tight text-slate-700 dark:text-slate-200">
        Learn the Thai words and phrases you need for any topic you choose. Get vocabulary words, key phrases, grammar explanations, and flashcards created for you in minutes.
    </p>
    <img class="w-2/3 sm:w-2/3 h-auto mx-auto my-16 rounded-xl shadow-xl border border-gray-700" src="/images/pages/learn-thai/learn thai with learning paths and flashcards.webp" alt="language learning paths for customized language learning"></img>
    ...
    <div class="container sm:mx-auto px-8">
        <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-16">
            ...
            <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                ...
                <h2 class="text-4xl font-bold mt-4">Let our AI create your personal path to Thai fluency in minutes</h2>
                <p class="mt-3"><strong>Choose your own Thai language learning topic</strong> and our AI will
                ...
                <p class="mt-4"><strong>Every lesson is enriched with</strong> audio pronounciaton examples, illustrative images, and grammar explanations.</p>
            </div>
            <!-- Column 2 -->
        ...
        <div class="flex flex-wrap md:flex-nowrap my-16 sm:my-16">
            ...
            <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-16">
                <span class="badge bg-teal-500 text-sm text-white font-bold py-2 px-3 rounded">KEY THAI VOCABULARY</span>
                <h2 class="text-4xl font-bold mt-4">Learn only the relevant Thai vocabulary you need</h2>
                <p class="mt-3">Instead of following a pre-made course with words you may not need, <strong>learn the most effective vocabulary</strong> list for your specific goals in Thailand, whether for family, travel, business, or cultural experiences.                
                </p>
        ...
        <div class="flex flex-wrap md:flex-nowrap my-16 sm:my-16">
            ...
            <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                ...
                <h2 class="text-4xl font-bold mt-4">Immerse yourself in the Thai language                                  
                </h2>                
                <p class="mt-3">Deepen your knowledge with learning paths that cover every aspect of the language. From common phrases to tricky sentences, learn to communicate effectively in Thai.</p>
        ...
        <div class="flex flex-wrap md:flex-nowrap my-16 sm:my-16">
            ...
            <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                ...
                <h2 class="text-4xl font-bold mt-4">Learn key phrases you can use with native Thai speakers</h2>
                <p class="mt-3">Start speaking Thai faster by learning <strong>key phrases</strong> that will help you <strong>become conversational in no time</strong>.</p>                    
            </div>
            <!-- Column 2 -->
        ...
        <div class="flex flex-wrap md:flex-nowrap my-16 sm:my-16">
            ...
            <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                ...
                <h2 class="text-4xl font-bold mt-4">Study Thai flashcards to memorize vocabulary faster</h2>
                ...
                <p class="mt-4">Every flashcard includes an image, voice pronounciation example, and multiple study modes. And you'll get email reminders when you need to study.</p>                                                            
            </div>
        </div>
        <div class="flex flex-wrap md:flex-nowrap my-16 sm:my-16">
            <!-- Column 1 -->
            <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                ...
                <h2 class="text-4xl font-bold mt-4">Gain insights into Thai culture</h2>
                <p class="mt-3">You can't learn a country's language <strong>without learning about its culture</strong>.</p>
                <p class="mt-4">Our cultural notes provide you with the essential background to navigate social and business interactions in Thailand effectively.</p>                
            </div>
            <!-- Column 2 -->
        ...
        <div class="flex flex-wrap md:flex-nowrap my-16 sm:my-16">
            ...
            <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                ...
                <p class="mt-3">Learning Thai can be extra challenging because you have to <strong>learn a brand new alphabet.</strong></p>
                <p class="mt-4">That's why we provide you with the <strong>most phonetically-friendly romanized spelling</strong>
                    of every word included in your learning path so you can learn to speak Thai even before learning the Thai alphabet.</p>                    
            </div>
        </div>
        ...
        <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-16">
            ...
            <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                ...
                <p class="mt-3">The beauty of our AI-powered platform is you can choose any scenario you want to speak Thai in, and <strong>you'll get a fully personalized learning path
                for that exact situation</strong>. Whether it's meeting family members, ordering at a restaurant, or making small talk at 7-11.</p>                
            </div>
            <!-- Column 2 -->        
            <div class="order-last sm:order-first md:w-1/2 flex justify-center items-center py-8 sm:p-16">
...
<div class="dark:bg-gray-900 pt-20 pb-16 px-5 sm:px-0 text-center lg:pt-16">
    <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 dark:text-gray-100 sm:text-7xl">        
        <span class="relative whitespace-nowrap text-teal-500 dark:text-teal-300">
            ...
            <span class="relative">Start learning Thai now!</span>
        </span>
    </h1>
    <p class="mx-auto mt-10 mb-12 max-w-3xl text-2xl tracking-tight text-slate-700 dark:text-gray-200">
        Create your own totally customized learning path based on any Thai topic you choose.
    </p>        
    <a href="{{ route('learning-paths.index', ['locale' => session('locale', 'en')])}}" class="bg-teal-500 hover:bg-teal-600 py-3 px-4 rounded-lg text-2xl font-semibold text-white shadow-lg">
        Try Now
    </a>
