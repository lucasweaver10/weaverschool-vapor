...
<main>
    <!-- hero -->
<div x-data="{ language: '', topic: '' }" class="pt-20 pb-16 text-center lg:pt-32">
    <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Learn new vocabulary with your personal
        <span class="relative whitespace-nowrap text-blue-400">
            ...
            <span class="relative">Language Sherpa</span>
        </span>
    </h1>
    <p class="mx-auto mt-6 max-w-2xl text-2xl tracking-tight text-slate-700">
        Pick a topic and a language for your Sherpa to guide you through
    </p>
    <div class="mt-10 flex justify-center gap-x-6">
        <div class="mt-5 sm:flex sm:items-center">
            <div class="w-full sm:max-w-xs mr-3">
                <label for="language" class="">Enter a language</label>
                <input type="language" x-model="language" id="email" class="block text-center w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Italian">
            </div>
            <div class="w-full sm:max-w-xs">
                <label for="topic" class="">Enter a topic</label>
                <input type="topic" x-model="topic" id="email" class="block text-center w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Ordering pizza">
            </div>
            <a x-bind:href="'/language-sherpa/journey?topic=' + topic + '&language=' + language" type="submit" class="w-48 items-center justify-center rounded-md bg-blue-400 px-3 py-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:ml-3 sm:mt-0 sm:w-auto">Follow your Sherpa</a>
        </div>
    </div>
</div>
<!-- End hero -->
