...
<form method="post" action="{{ route('guides.store') }}" class="">
        @csrf
    <div class="space-y-8 divide-y divide-gray-200 p-10">
        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
            <div>
                <div>
                    <h2 class="text-xl leading-6 font-large text-gray-900">Create a Guide</h2>
                </div>
                    ...
                    <div class="sm:grid sm:grid-cols-8 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="mt-1 sm:mt-0 sm:col-span-7">
                            <div class="max-w-lg flex rounded-md shadow-sm">
                                <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 sm:text-sm"> weaverschool.com/guides/ </span>
