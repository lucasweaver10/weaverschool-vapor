<x-layouts.app>      
    <x-slot name="title">
        AI Cambridge Coach from the Weaver School
    </x-slot>
    <x-slot name="description">
        Get your personal AI Cambridge Coach to easily pass your Cambridge Exam. Complete with interactive AI tools and practice tests to help you improve your speaking and writing scores.
    </x-slot>
<x-layouts.guest>
<main>
    <!-- hero -->
<div class="bg-gray-900 pt-20 pb-16 px-5 sm:px-0 text-center lg:pt-16">
    <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-gray-100 sm:text-7xl">
        Pass your Cambridge exam easily with your personal
        <span class="relative whitespace-nowrap font-bold text-teal-400 animate-pulse">
            ...
            <span class="relative">AI Cambridge Coach</span>
        </span>
        
    </h1>
    <p class="mx-auto mt-10 max-w-4xl text-2xl tracking-tight text-slate-200">
        Prepare for your Cambridge exam with interactive AI tools and practice tests to help you improve your <strong><a href="#speaking">speaking</a></strong> and <strong><a href="#writing">writing</a></strong> skills.
    </p>
    ...
    <div class="mt-10 flex justify-center gap-x-6 sm:gap-x-8">
        <a href="{{ route('dashboard.exam-prep.cambridge.speaking.practice-tests.index', ['locale' => session('locale', 'en')]) }}" role="button" class="bg-teal-500 hover:bg-teal-700 py-3 px-4 rounded-lg text-2xl font-semibold text-white">Try Now</a>
        @guest
        ...
        <div class="dark:bg-gray-200 container sm:mx-auto px-8">
            ...
            <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-16">
                ...
                <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                    ...
                    <p class="mt-3">Practice your skills for the Cambridge Speaking Section by taking practice tests with real audio questions and recording your own answers.</p>                    
                ...
                <div class="md:w-1/2 flex justify-center items-center mx-auto py-8 sm:py-0 sm:p-16">                
                    <img src="/images/pages/cambridge/cambridge speaking exam practice tests.jpg" alt="cambridge speaking practice tests" class="rounded-lg max-w-full h-auto">                
                </div>
            </div>
             <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-8">
                ...
                <div class="order-last sm:order-first md:w-1/2 flex justify-center items-center py-8 sm:py-0 sm:p-8">
                    <img src="/images/pages/ielts/ielts speaking coach sentence overview.jpg" alt="cambridge speaking test ai answer analysis" class="rounded-lg max-w-full h-auto">                
                </div>
                <!-- Column 2 -->        
            ...
            <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-16">
                ...
                <!-- Column 2 -->
                <div class="md:w-1/2 flex justify-center items-center mx-auto py-8 sm:py-0 sm:p-16">                
                    <img src="/images/pages/ielts/ielts speaking coach word breakdown.jpg" alt="cambridge speaking ai pronouncation evaluation" class="rounded-lg max-w-full h-auto">                
                </div>
            </div>
            <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-16">
                <!-- Column 1 -->
                <div class="md:w-1/2 flex justify-center items-center mx-auto py-8 sm:py-0 sm:p-16">                
                    <img src="/images/pages/cambridge/cambridge speaking practice exam question.jpg" alt="pratice all sections of the cambridge speaking exam" class="rounded-lg max-w-full h-auto">                
                </div>                
                <!-- Column 2 -->
                <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                    <span class="badge bg-teal-500 text-sm text-white font-bold py-2 px-3 rounded">ALL EXAM SECTIONS AVAILABLE</span>
                    <h2 class="text-4xl font-bold mt-4">Practice Parts 1, 2, 3, & 4 of the Speaking Section</h2>
                    <p class="mt-3">Each practice exam is complete with all the required questions for each part of the Cambridge Speaking section, so you can speak confidently on each section.</p>                                        
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container sm:mx-auto px-8">
            ...
            <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-8">
                ...
                <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                    ...
                    <h2 class="text-4xl font-bold mt-4">Part One & Two Essay Analysis</h2>
                ...
                <!-- Column 2 -->
                <div class="md:w-1/2 flex justify-center items-center mx-auto py-8 sm:py-0 sm:p-16">                    
                    <img src="/images/pages/cambridge/cambridge essay feedback.jpg" alt="cambridge writing ai analysis" class="rounded-lg max-w-full h-auto">                
                </div>
            </div>
            <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-16">
                <!-- Column 1 -->
                <div class="md:w-1/2 flex justify-center items-center mx-auto py-8 sm:py-0 sm:p-16">                
                    <img src="/images/pages/cambridge/submit a cambridge essay.jpg" alt="ai cambridge writing checker for task 1 essays" class="rounded-lg max-w-full h-auto">                
                </div>
                <!-- Column 2 -->            
                <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                    <span class="badge bg-teal-500 text-sm text-white font-bold py-2 px-3 rounded">RELEVANCE RECOGNITION</span>
                    <h2 class="text-4xl font-bold mt-4">Task Achievement Recognition</h2>
                    <p class="mt-3">Submit your topic with your essay submission and get accurate feedback on your task achievement related to the topic you submit.</p>
                    </p>
            ...
            <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-8">
                ...
                <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                    ...
                    <p class="mt-3">The number one thing you can do to improve your Cambridge essays in all 4 scoring criteria is learning how to write a good thesis statement.</p>
                    </p>
                    <p class="mt-4">Your Cambridge AI Coach will teach you how to write a thesis statement from an Cambridge essay topic and how to use it to score more points.</p>
                </div>
                <!-- Column 2 -->
                <div class="md:w-1/2 flex justify-center items-center mx-auto py-8 sm:py-0 sm:p-16">                
                    <img src="/images/pages/ielts/ai ielts coach thesis statements.jpg" alt="cambridge thesis statement trainer" class="rounded-lg max-w-full h-auto">                
                </div>
            </div>
            ...
            <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-8">
                <!-- Column 1 -->
                <div class="order-last sm:order-first md:w-1/2 flex justify-center items-center py-8 sm:py-0 sm:p-8">
                    <img src="/images/pages/ielts/ai ielts coach writing outlines.jpg" alt="tool for writing cambridge outlines" class="rounded-lg max-w-full h-auto">                
                </div>
                <!-- Column 2 -->        
                <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-16">
                    ...
                    <p class="mt-4">Let your AI Cambridge Coach teach you step by step how to write a Task Two outline that you can turn into a full essay, getting
            ...
            <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-8">
                ...
                <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-8">
                    ...
                    <h2 class="text-4xl font-bold mt-4">Complete Cambridge Writing Preparation</h2>
                    <p class="mt-3">Don't just check your essays. Learn how to write high-scoring essays before you check their score.</p>
                    </p>
                    <p class="mt-4">Take advantage of complete Cambridge writing exam preparation with personalized AI feedback and coaching on your writing.</p>
                </div>
                <!-- Column 2 -->
                <div class="md:w-1/2 flex justify-center items-center mx-auto py-8 sm:py-0 sm:p-16">                
                    <img src="/images/pages/ielts/ai ielts coach writing feedback.jpg" alt="complete cambridge writing preparation" class="rounded-lg max-w-full h-auto">                
                </div>
            </div>
            ...
            <div class="flex flex-wrap md:flex-nowrap py-16 sm:py-8">
                ...
                <div class="md:w-1/2 flex flex-col justify-center items-start sm:p-16">
                    ...
                    <p class="mt-3">Learn how to write better introductions by rewriting the question using synonyms and practice with your AI Cambridge Coach.</p>
                    </p>
                    <p class="mt-4">Improve your Lexical Resource score and get real-time feedback every time you write an introduction.</p>
                </div>
                <!-- Column 2 -->                        
                <div class="order-last sm:order-first md:w-1/2 flex justify-center items-center py-8 sm:py-0 sm:p-8">
                    <img src="/images/pages/ielts/ai ielts coach introductions.jpg" alt="improve cambridge introductions" class="rounded-lg max-w-full h-auto">                
                </div>
            </div>
        </div>
    </div>
