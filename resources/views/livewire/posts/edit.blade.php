<div class="space-y-8 divide-y divide-gray-200 mx-5">
    <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
        <div>
            ...
            <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                ...
                <div class="sm:grid sm:grid-cols-8 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    <label for="published_at" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"> Published at {{ $this->post->published_at }} </label>
                    <div class="mt-1 sm:mt-0 sm:col-span-7">
                        <div class="max-w-lg flex rounded-md shadow-sm">
                ...
                {{-- <div class="sm:grid sm:grid-cols-8 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-7">
                        ...
                        <div wire:ignore>
                            ...
                            <textarea wire:ignore wire:key="editor-{{ now() }}" wire:model="content" class="bg-white" input="content">{!! $this->post->content !!}</textarea>
                            <script>
                ...
                <div wire:ignore class="mt-5">
                    ...
                    <input id="content" type="hidden" name="content" value="content">
                    <textarea wire:ignore wire:key="editor-{{ now() }}" wire:model.live="content" input="content">{!! $this->post->content !!}</textarea>
                        {{-- <script>
                            const easyMDE = new EasyMDE();
                            easyMDE.codemirror.on("change", () => {
                            @this.set('content', easyMDE.value());
    ...
    <div class="pt-5">
        <div class="flex">
            ...
            <button wire:click="update" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Save</button>
        </div>
    </div>
