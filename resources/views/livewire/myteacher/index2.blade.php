        ...
        <div class="flex-1 flex flex-col min-h-0 bg-gray-200">
            <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                ...
                <nav class="mt-5 flex-1 px-2 space-y-1">
                    <!-- Current: "bg-blue-800 text-white", Default: "text-white hover:bg-blue-600 hover:bg-opacity-75" -->
                    <a href="#" class="bg-blue-400 text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        <!-- Heroicon name: outline/home -->
                    ...
                    <a href="/myteacher/courses" class="text-gray-600 hover:text-white hover:bg-blue-400 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        <!-- Heroicon name: outline/users -->
                        <svg class="mr-3 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                    ...
                    <a href="#" class="text-gray-600 hover:text-white hover:bg-blue-400 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        <!-- Heroicon name: outline/folder -->
                        <svg class="mr-3 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                        </svg>
...
{{--                    <a href="#" class="text-black hover:text-white hover:bg-blue-400 group flex items-center px-2 py-2 text-sm font-medium rounded-md">--}}
{{--                        <!-- Heroicon name: outline/calendar -->--}}
{{--                        <svg class="mr-3 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">--}}
{{--                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />--}}
{{--                        </svg>--}}
                ...
                <a href="#" class="flex-shrink-0 w-full group block">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xs font-medium text-blue-200 group-hover:text-white">View profile</p>
                        </div>
                    </div>
                </a>
            </div>
