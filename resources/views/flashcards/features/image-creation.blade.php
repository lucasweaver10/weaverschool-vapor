<x-layouts.app title="Online English courses | The Weaver School">      
    <x-slot name="title">
        Flashcard features: AI image creation
    </x-slot>
    <x-slot name="description">
        Add images to your flashcards with the click of a button using our AI image creation tool. A picture's worth a thousand words, and it will help you learn vocabulary words faster too.
    </x-slot>
<x-layouts.guest>
<main>
    <!-- Breadcrumb -->
...
<div class="pt-20 pb-10 px-5 sm:px-0 text-center lg:pt-16">
    <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Add AI created images to flashcards in seconds             
    </h1>
    ...
    <div class="prose prose-2xl mx-auto p-5 text-left">
        <h2>Benefits of adding images to flashcards</h2>
        <p>The flashcard app from the Weaver School includes the creation of flashcards with beautiful and engaging AI images.<p>
        <p>Adding images to your flashcards can help you learn vocabulary words faster. Here's why:</p>
        <p>One thing you can do to make sure you learn faster it to rcruit more areas of your brain during the learning and study process. The more areas of your brain you can activate, the more likely you are to remember the information.</p>
        <h3>How to use flashcard images to learn faster</h3>
        <p>The way you can activate more areas of your brain is by engaging more senses simultaneously.<p>

        <p>For instance, seeing and reading a flashcard is one sense. But hearing it spoken out loud is another. We also use different parts of our brains reading text than we do interpreting images. So adding images to your flashcards is another way to activate more areas.</p>
        <p>You can also use images in study mode to make sure you're not relying on translation too much.</p>
        <p>Translation is useful in the beginning, but long-term it will slow you down.</p>
        <p>By using image mode, you're able to build your neural network in your target language.</p>
