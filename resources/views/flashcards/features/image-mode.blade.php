<x-layouts.app title="Online English courses | The Weaver School">      
    <x-slot name="title">
        Flashcard features: Study flashcards with image mode
    </x-slot>
    <x-slot name="description">
        Learn how to study flashcards with image mode in our flashcard app. Image mode helps you build your neural network in your target language and stop translating.
    </x-slot>
<x-layouts.guest>
<main>
    <!-- Breadcrumb -->
...
<div class="pt-20 pb-10 px-5 sm:px-0 text-center lg:pt-16">
    <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Study flashcards with image mode        
    </h1>
    ...
    <div class="prose prose-2xl mx-auto p-5 text-left">
        <div class="prose prose-2xl mx-auto p-5 text-left">
            <h2>Benefits of using Image Mode when studying flashcards</h2>
            <p>The flashcard maker from the Weaver School includes the creation of flashcards with beautiful and engaging AI images for every flashcard set you create.<p>
            <p>Using image mode can help you learn vocabulary words faster. Here's how:</p>
            ...
            <h3>How to use Image Mode to learn faster</h3>
            ...
            <p>Using image mode, you make sure you're not relying on translation too much.</p>
