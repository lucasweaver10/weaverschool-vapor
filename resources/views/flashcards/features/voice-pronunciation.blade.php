<x-layouts.app title="Online English courses | The Weaver School">      
    <x-slot name="title">
        Flashcard features: AI voice pronunciation examples
    </x-slot>
    <x-slot name="description">
        Add voice pronunciation examples to each of your flashcards using realistic native-sounding AI voices.
    </x-slot>
<x-layouts.guest>
<main>
    <!-- Breadcrumb -->
...
<div class="pt-20 pb-10 px-5 sm:px-0 text-center lg:pt-16">
    ...
    <div class="prose prose-2xl mx-auto p-5 text-left">
        <h2>Adding pronunciation examples to your flashcards</h2>
        <p>If you create your flashcards using our Create from a File or Topic features, we'll automatically add audio to the flashcards for you, using realistic, human-sounding AI voices.</p>

        <p>However, if you created an individual flashcard by yourself, you can easily add a pronunciation example to it just by clicking the sound icon, and then choosing the language the word is in.</p>

        <p>After a few seconds, the new audio example will be generated and added to your flashcard for you to use in study mode.</p>
        <h3>Why do you need pronunciation examples?</h3>
        <p>Adding pronunciation examples to your flashcards is a great way to improve your pronunciation skills. It allows you to hear the word, and say it out loud yourself, helping you to work on actually learning how to speak the word, rather than memorizing it.</p>
        <p>You'll also engage more parts of the brain in the learning process, which will help you learn faster and more richly.</p>
    </div>
