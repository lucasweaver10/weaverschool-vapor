<x-layouts.app title="Online English courses | The Weaver School">      
    <x-slot name="title">
        Flashcard features: Create flashcards from a topic
    </x-slot>
    <x-slot name="description">
        Choose a topic you want to learn about and our AI will create a flashcard set from the topic.
    </x-slot>
<x-layouts.guest>
<main>
    <!-- Breadcrumb -->
...
<div class="pt-20 pb-10 px-5 sm:px-0 text-center lg:pt-16">
    ...
    <div class="prose prose-2xl mx-auto p-5 text-left">
        <h3>How to create flashcards from a Topic</h3>
        <p>On your Flashcard Sets page click on the “Create from Topic” button.</p>

        <p>All you have to do here is enter a language learning topic that you want to learn about. You can write a full paragraph here giving all the context around the topic you want.</p>

        <p>Behind the scenes, we'll use a combination of AI providers behind the scenes to generate a list of relevant vocabulary words for your topic and create flashcards for you with either definitions or translations.</p>

        <p>After a couple minutes you can then check in your dashboard for your new flashcard set. From there you can customize the cards if you wish, or remove any that are irrelevant.</p>
