<x-layouts.app title="Online English courses | The Weaver School">      
    <x-slot name="title">
        Flashcard features: Spaced repetition reminders
    </x-slot>
    <x-slot name="description">
        Spaced repetition reminders tell you when to study flashcards again so you won't forget them. Learn more about this feature.
    </x-slot>
<x-layouts.guest>
<main>
    <!-- Breadcrumb -->
...
<div class="pt-20 pb-10 px-5 sm:px-0 text-center lg:pt-16">
    <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Use spaced repetition reminders to study flashcards at just the right time            
    </h1>
    ...
    <div class="prose prose-2xl mx-auto p-5 text-left">
        <h2>How to use Spaced Repetition to memorize flashcards faster</h2>
        <p>Spaced repetition is a learning technique that involves strategically spacing out the time between learning sessions to increase long-term memory retention and increase learning efficiency.</p>

        <p>The concept is based on the idea that revisiting material at frequent, but increasingly spaced-out intervals, aids in long-term memory formation. It’s a concept that has been used by many successful students and professionals to increase their knowledge and understanding.</p>

        <h3>How does it work?</h3>
        <p>Spaced repetition involves setting set times or intervals to learn and then review new information. You can break the process down into the following steps:</p>

        <h4>Initial learning</h4>
        <p>When you encounter a new word, you learn its meaning and how to use it in context. This could be through reading, studying, or using a vocabulary-learning app or flashcards.</p>

        <h4>First review</h4>
        <p>Shortly after learning the word, you review it again to reinforce your memory. This initial review helps to solidify the new vocabulary in your mind.</p>

        <h4>Scheduling reviews</h4>
        <p>Based on the concept of the forgetting curve, which describes how information fades from memory over time, spaced repetition algorithms determine the ideal timing for future reviews. Words that you have difficulty remembering are scheduled for more frequent reviews, while those you recall easily are scheduled for less frequent reviews.</p>

        <h3>Automatic spaced repetition reminders</h3>
        <p>The flashcard tool at the Weaver School includes automatic spaced repetition reminders for flashcards that you need to review to make sure you remember and don't forget later.</p>
        <p>Any flashcards you need to study will be emailed to you that day to make sure you can jump back into the app and study them.</p>
    </div>
