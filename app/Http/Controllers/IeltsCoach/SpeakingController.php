...
class SpeakingController extends Controller
{
    ...
    {        
        ...
        $tests = SpeakingPracticeTest::where('exam', 'IELTS')->get();
        return view('dashboard.exam-prep.ielts.speaking.practice-tests.index', compact('tests', 'pro'));
    }
    ...
    public function submit($locale, $id)
    {
        ...
        return view('dashboard.exam-prep.ielts.speaking.practice-tests.submit', compact('test'));
    }

    public function feedbackIndex()
    {
        $submissions = auth()->user()->speakingPracticeTestSubmissions()->with('test')->where('exam', 'IELTS')->get();        
        return view('dashboard.exam-prep.ielts.speaking.practice-tests.feedback.index', compact('submissions'));
    }
    ...
    public function feedbackShow($locale, $id)
    {
        ...
        return view('dashboard.exam-prep.ielts.speaking.practice-tests.feedback.show', compact('submission', 'averageScores'));
    }
}
