...
class CreateFlashcardSymbolicImageWithOpenAiFromEnglish implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        if(!$flashcard) {
            Log::error("Failed to find flashcard with ID: $this->flashcardId");
            return;
        }
        ...
        $imageUrl = $openAiController->createSymbolicFlashcardImage($term, $definition);
