...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'The Weaver School'),
   ...
   |--------------------------------------------------------------------------
   |
   | This value is the logo file of your application. This value is used when the
   | framework needs to place the application's logo in a notification or
   | any other location as required by the application or its packages.
   |
   */

    'logo' => '/images/logos/ws_logo_wordmark.svg',
    'logo_dark' => '/images/logos/weaver_school_logo_dark.png',
    'favicon' => '/images/logos/ws_logomark.svg',
    ...
    */
    ...
    'url' => env('APP_URL', 'https://weaverschool.com'),
